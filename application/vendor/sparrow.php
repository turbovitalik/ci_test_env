...
class Sparrow {
    ...
    protected static $savepointTransactions = array("pgsql", "mysql", "mysqli");
    ...
    public function start_trans() {
        ...
        if($this->transLevel == 0 || !$this->nestable()) {
            ...
            $this->sql(array("SAVEPOINT LEVEL{$this->transLevel}"));
        }
    ...
    public function commit() {
        ...
        if($this->transLevel == 0 || !$this->nestable()) {
            ...
            $this->sql(array("RELEASE SAVEPOINT LEVEL{$this->transLevel}"));
        }
    ...
    public function rollback() {
        ...
        if($this->transLevel == 0 || !$this->nestable()) {
            ...
            $this->sql(array("ROLLBACK TO SAVEPOINT LEVEL{$this->transLevel}"));
        }
