...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(1), __webpack_require__(3), __webpack_require__(30).setImmediate))
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__node_modules_axios_index_js__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__node_modules_axios_index_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__node_modules_axios_index_js__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__event_bus__ = __webpack_require__(10);
...
Vue.component('login', {
   ...
   methods: {
       login: function (event) {
           __WEBPACK_IMPORTED_MODULE_0__node_modules_axios_index_js___default.a.get('/auth/login')
               .then(res => {
...
Vue.component('like-button', {
    ...
    methods: {
        ...
        like: function (event) {
            ...
            __WEBPACK_IMPORTED_MODULE_0__node_modules_axios_index_js___default.a.defaults.headers = { Authorization: "Bearer" + '12345' };

            __WEBPACK_IMPORTED_MODULE_0__node_modules_axios_index_js___default.a.post(this.likeUrl, this.composePostData(), { headers: this.getAuthorizationHeader()})
                .then(res => {
        ...
        unlike: function (event) {
            ...
            __WEBPACK_IMPORTED_MODULE_0__node_modules_axios_index_js___default.a.post(this.unlikeUrl, this.composePostData())
                .then(res => {
    ...
    computed: {
        count: {
            ...
            set: function (value) {
                console.log(this.liked)
                __WEBPACK_IMPORTED_MODULE_1__event_bus__["a" /* default */].$emit('update-likes', { likes: value, item_id: this.id, type: this.postDataMap.type, isLike: this.liked });
            }
        },
        actionName: {
            get: function () {
...
const News = Vue.component('latest-news', {
    ...
    created() {
        __WEBPACK_IMPORTED_MODULE_0__node_modules_axios_index_js___default.a.get('/news/news')
            .then(response => {
...
const SingleNews = Vue.component('single-news', {
    ...
    created() {
        __WEBPACK_IMPORTED_MODULE_0__node_modules_axios_index_js___default.a.get('/news/news_single/' + this.$route.params.id)
            .then(response => {
    ...
    mounted() {
        let me = this;
        __WEBPACK_IMPORTED_MODULE_1__event_bus__["a" /* default */].$on('update-likes', function (data) {
...
Vue.component('comments', {
    ...
    methods: {
        ...
        submitComment: function() {
            __WEBPACK_IMPORTED_MODULE_0__node_modules_axios_index_js___default.a.post('/news/comment', { news_id: this.newsId, comment: this.reply, user_id: this.getUserId() }) //todo: hardcoded data
                .then(res => {
                    if(this.reply !== '') {
